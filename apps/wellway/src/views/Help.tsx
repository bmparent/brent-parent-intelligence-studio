  ...
  return (
    <>
      ...
      <div className="two-column">
        <section className="panel">
          ...
          <dl className="capability-list">
            ...
            <div>
              <dt>AI assistance</dt>
              <dd>
                Guided explanations are always available. When live AI is
                available, choose it in the assistant or visit preparation. Each
                response identifies its mode.
              </dd>
            </div>
            <div>
              <dt>File backups</dt>
              <dd>
                Export and restore your saved workspace. Backups do not sync
                automatically.
              </dd>
            </div>
          </dl>
        ...
        <section className="panel">
          ...
          <p>
            ...
            stored in this browser. Use fictional information only.
          </p>
          <p>
      ...
      <section className="panel faq">
        ...
        <details>
          <summary>How do I use live AI?</summary>
          <p>
            Open the assistant and choose “Use live AI” when its connection is
            available. Only the supplied fictional records and your conversation
            are sent to OpenAI. You can inspect the records cited by each
            response. If a request fails or the shared allowance is used, try
            guided answers. No plan is approved by AI.
          </p>
        </details>
        <details>
          <summary>What can I try in the video visit?</summary>
          <p>
            Choose “Join visit” on Today or Advisor. Prepare your agenda,
            explore the scripted discussion, and end the visit to edit its
            follow-up. Save it for advisor review; only approval updates the
            plan. Portraits, participants, captions, and health history are
            fictional. Camera and microphone buttons simulate controls without
        ...
        <details>
          ...
          <p>
            ...
            app on the other computer. Use Restore backup there. Changes do not
            automatically follow you between devices.
          </p>
        </details>
        <details>
