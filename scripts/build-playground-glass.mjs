...
await writeFile('functions/_shared/platform/playgroundSchema.ts',(await readFile('functions/_shared/platform/playgroundSchema.ts','utf8'))+'export const aiSchema = '+JSON.stringify(aiSchema)+';\n');
...
const css = (await readFile('src/styles/liquid-glass.css','utf8')).replace(/\r\n/g, '\n');
