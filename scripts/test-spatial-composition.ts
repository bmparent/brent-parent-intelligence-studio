import { applyProposal } from '../src/playground-spatial/aiOperations';
import test from 'node:test';
import assert from 'node:assert/strict';
import { createProject, validateProject, upgradeProject, sectionKind, mediaSlots, projectWarnings, type Project } from '../src/playground-spatial/model';
import { defaultComposition, validateComposition, effectivePlacement, compositionParts, imagePlacements, type Composition } from '../src/playground-spatial/compositionSchema';
import { enableComposition, applyCompositionOperation, moveSectionBefore } from '../src/playground-spatial/composition';
import { compositionMarkup, compositionStyles } from '../src/playground-spatial/compositionRenderer';
