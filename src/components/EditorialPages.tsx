...
export function ContactPage() {
  return (
      <section className="ew-contact-page ew-shell">
       <div className="ew-contact-page__intro"><p className="ew-eyebrow">Contact</p><h1>Tell Eidos Works what you are trying to improve.</h1><p>Share the customer path, storefront constraint, reporting gap, or repeated manual work. You do not need a finished brief.</p><p>Email directly: <SafeEmailLink address={siteConfig.projectsEmail}><EmailAddress address={siteConfig.projectsEmail} /></SafeEmailLink></p></div>
      <ContactForm />
    </section>
  );
}
