...
export function useProject() {
  // New local workspaces show drag handles immediately. Imported and saved
  // projects retain their own version; upgrading them remains explicit/undoable.
  const [state, dispatch] = useReducer(workspaceReducer, undefined, () => workspace(enableComposition(createProject()), crypto.randomUUID()));
