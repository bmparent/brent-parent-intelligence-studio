...
export function authoringStyles(sections: Section[]): string {
    ...
    return css + nodes.map(n => {
        const id = '#' + n.id, m = n.media, align = n.align === 'left' ? 'flex-start' : n.align === 'right' ? 'flex-end' : 'center';
