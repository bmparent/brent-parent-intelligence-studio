/* eslint-disable */
// Generated by Wrangler by running `wrangler types ops/snapshot-worker/worker-configuration.d.ts --config ops/snapshot-worker/wrangler.jsonc --env-interface SnapshotWorkerEnv --strict-vars=false` (hash: aa7078a5e7c3f7cb41f99f3898e03667)
// Runtime types generated with workerd@1.20260603.1 2026-09-21 nodejs_compat
interface __BaseEnv_SnapshotWorkerEnv {
	SNAPSHOT_OBJECTS: R2Bucket;
...
declare namespace Cloudflare {
	...
	interface Env extends __BaseEnv_SnapshotWorkerEnv {}
}
interface SnapshotWorkerEnv extends __BaseEnv_SnapshotWorkerEnv {}
type StringifyValues<EnvType extends Record<string, unknown>> = {
	[Binding in keyof EnvType]: EnvType[Binding] extends string ? EnvType[Binding] : string;
};
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SNAPSHOT_GENERATION_ENABLED" | "SNAPSHOT_CAPTURE_APPROVED" | "SNAPSHOT_DAILY_ALLOWANCE_CENTS" | "SNAPSHOT_MAX_JOB_COST_CENTS" | "OPENAI_TEXT_MODEL" | "OPENAI_IMAGE_MODEL">> {}
}
